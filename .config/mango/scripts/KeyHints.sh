...
shortcuts=(
  ...
  "Scratchpads :: SUPER + CTRL + U :: Restore Minimized :: mmsg dispatch restore_minimized"

  "Layout :: ALT + E :: Set Proportion 1.0 :: mmsg dispatch set_proportion 1.0"
  "Layout :: ALT + X :: Switch Proportion Preset :: mmsg dispatch switch_proportion_preset"

  "Mouse :: SUPER + Left Click :: Move Window :: moveresize curmove"
  "Mouse :: SUPER + Right Click :: Resize Window :: moveresize curresize"
  "Mouse :: SUPER + Scroll Up :: Previous Tag :: viewtoleft_have_client"
  "Mouse :: SUPER + Scroll Down :: Next Tag :: viewtoright_have_client"
  ...
  "Shell Aliases :: c / q :: Clear / Exit :: c / q"
  "Shell Aliases :: .. / ... / .... :: Navigate Up :: cd .. / ... / ...."
  "Shell Aliases :: ls / ll / la / lt :: List Files (eza) :: ls / ll / la / lt"
  "Shell Aliases :: grep / find :: ripgrep / fd :: rg / fd"
  "Shell Aliases :: update :: System Update (yay) :: yay -Syu"
  "Shell Aliases :: install <pkg> :: Install Package :: yay -S"
  "Shell Aliases :: remove <pkg> :: Remove Package :: yay -Rns"
  "Shell Aliases :: search <pkg> :: Search Package :: yay -Ss"
  "Shell Aliases :: make / ninja :: Parallel Build :: make -j\$(nproc) / ninja -j\$(nproc)"
  "Shell Aliases :: conf-mango :: Edit Mango Config :: nvim ~/.config/mango/config.conf"
  "Shell Aliases :: conf-zsh :: Edit Zsh Config :: nvim ~/.config/zsh/.zshrc"
  "Shell Aliases :: conf-kitty :: Edit Kitty Config :: nvim ~/.config/kitty/kitty.conf"
  "Shell Aliases :: conf-zj :: Edit Zellij Config :: nvim ~/.config/zellij/config.kdl"
  "Shell Aliases :: reload-zsh :: Reload Zsh Config :: source ~/.config/zsh/.zshrc"
  "Shell Aliases :: g / gst / gd :: Git Status/Diff :: git status/diff"
  "Shell Aliases :: ga / gc / gp / gpl :: Git Add/Commit/Push/Pull :: git add/commit/push/pull"
  "Shell Aliases :: gl / glog / gadog :: Git Log :: git log variants"
  "Shell Aliases :: zj / zja / zm :: Zellij Sessions :: zellij"
  "Shell Aliases :: zjl / zjda :: Zellij List/Delete All :: zellij list/delete"
  "Shell Aliases :: dk-start / dk-stop / dk-status :: Docker Control :: systemctl docker"
  "Shell Aliases :: zplu :: Update Zsh Plugins :: zplugin-update"
  "Shell Aliases :: y :: Yazi (preserve cwd) :: yazi wrapper"
