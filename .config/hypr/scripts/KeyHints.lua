...
local shortcuts = {
  ...
  { "update",                    "[Command] Atualizar Sistema Completo (yay)",    "yay -Syu" },
  { "install <pkg>",             "[Command] Instalar Pacote",                     "yay -S" },
  { "remove <pkg>",              "[Command] Remover Pacote e Dependências",       "yay -Rns" },
  { "search <pkg>",              "[Command] Pesquisar Pacote",                    "yay -Ss" },
