...
local shortcuts = {
  ...
  { "Hypr",     "SUPER + G",                 "Toggle Window Group (Tabs)",    "hyprctl dispatch togglegroup" },
  ...
  { "Hypr",     "SUPER + TAB / ALT + TAB",   "Toggle Overview",               "toggle_overview (scrolloverview)" },
  { "Hypr",     "SUPER + SHIFT + T",         "Toggle Dropdown Terminal",      "kitty-drop (Scratchpad)" },
  ...
  { "Noctalia", "SUPER + SHIFT + W",         "Toggle Dark/Light Theme",       "noctalia msg theme-mode-toggle" },
  ...
  { "Term",     "SUPER + T",                 "Open Terminal",                 "kitty" },
