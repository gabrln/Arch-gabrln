...
local shortcuts = {
  ...
  { "update",                    "[Command] Atualizar Sistema Completo (shelly)", "shelly upgrade-all" },
  { "install <pkg>",             "[Command] Instalar Pacote",                     "shelly install" },
  { "remove <pkg>",              "[Command] Remover Pacote e Dependências",       "shelly remove" },
  { "search <pkg>",              "[Command] Pesquisar Pacote",                    "shelly query" },
