...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("systemctl --user reset-failed xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk")
	hl.exec_cmd("systemctl --user restart xdg-desktop-portal xdg-desktop-portal-hyprland xdg-desktop-portal-gtk")
