-- =========================================================================
-- Animações do Hyprland e Curvas Bezier (Módulo Lua)
-- =========================================================================

hl.config({ animations = { enabled = true } })

-- Curvas Bezier para transições fluidas
...
-- Animações de janelas: padronizadas, rápidas e mínimas
...
-- Scratchpads (special workspace): vir de baixo ao abrir e ir para baixo ao fechar
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 3,  bezier = "wind",      style = "slidevert" })

-- Animações de interface (barras, painéis, wallpaper) com fade suave no login
