...
shortcuts=(
  ...
  "Term      ::  update                     ::  System Update (shelly)         ::  shelly upgrade-all"
  "Term      ::  install <pkg>              ::  Install Package               ::  shelly install"
  "Term      ::  remove <pkg>               ::  Remove Package                ::  shelly remove"
  "Term      ::  search <pkg>               ::  Search Package                ::  shelly query"
